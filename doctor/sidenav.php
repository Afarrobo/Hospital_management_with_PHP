...
<head>
    ...
    <style>
        .bg-purple {
            background-color: rgb(125, 93, 200) !important;

        }

        .bg-purple a:hover {
            background-color: rgb(163, 50, 137) !important;
        }
    </style>
</head>
...
<body>
    <div class="list-group bg-purple" style="height: 90vh;">
        ...
        <a href="admin.php" class="list-group-item list-group-item-action bg-purple text-center text-white border-0">Patient</a>
        <a href="doctor.php" class="list-group-item list-group-item-action bg-purple text-center text-white border-0">Appointment</a>
